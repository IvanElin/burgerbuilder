...
const addIngredient = (state, action) => {
    const updatedIngredient = { [action.ingridientName]: state.ingredients[action.ingridientName] + 1 };
...
const removeIngredient = (state, action) => {
    const updatedIng = { [action.ingridientName]: state.ingredients[action.ingridientName] - 1 };
